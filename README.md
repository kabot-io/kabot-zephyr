...
All of the code must be committed using [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/). They are later used to construct changelog during tagged release.
