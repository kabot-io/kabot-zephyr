...
#if defined(CONFIG_SETTINGS)
static int read_string_value(settings_read_cb read_cb,
                             void *cb_arg,
                             size_t len_rd,
                             char *dst,
                             size_t dst_size)
...
static int robot_settings_handler_set(const char *name,
                                      size_t len_rd,
...
static int robot_settings_handler_export(int (*cb)(const char *name,
                                                   const void *value,
                                                   size_t val_len))
{
...
SETTINGS_STATIC_HANDLER_DEFINE(kabot_settings,
                               "kabot",
                               NULL,
                               robot_settings_handler_set,
                               NULL,
...
int robot_settings_init(void)
{
    ...
    LOG_INF("Robot settings ready: serial=%s name=%s hmi=%s:%u",
            serial,
            human_name,
            ip,
            (unsigned int)port);
...
void robot_settings_get_identity(char *serial_out,
...
void robot_settings_get_claim_state(bool *claimed_out,
                                    char *claimed_by_ip_out,
